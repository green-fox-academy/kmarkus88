public class BlogPost {
    public static void main(String[] args) {
        Blogs blogs1 = new Blogs("John Doe", "Lorem Ipsum", "Lorem ipsum dolor sit amet", "2000.05.04");
        Blogs blogs2 = new Blogs("Tim Urban", "Wait but why", "A popular long-form, stick-figure-illustrated blog about almost everything.", "2010.10.10");
